      ...
      {!loading && courses.length > 0 && (
        <div className="relative p-3">
          ...
          <button
            ...
            className="absolute left-0 top-[40%] bg-[#2a619d] p-2 rounded-full text-white disabled:opacity-50 z-10"
          >
          ...
          <button
            ...
            className="absolute right-0 top-[40%] bg-[#2a619d] p-2 rounded-full text-white disabled:opacity-50 z-10"
          >
