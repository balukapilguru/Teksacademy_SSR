    ...
    <div className="relative rounded-2xl text-white overflow-hidden mt-5">
      ...
      <div className="relative z-10 max-w-8xl pl-4  lg:pl-6 lg:pr-0 lg:pb-0 lg:pt-0 grid grid-cols-1 lg:grid-cols-2  lg:gap-10 items-center">
        <div>
          ...
          {/* Description FIXED */}
          <p className="mt-4 text-gray-300 text-base text-justify sm:text-lg leading-relaxed pr-2">
            {data.paragraph}
          </p>
          ...
          <div className="mt-4 lg:mb-4 flex flex-wrap gap-4">
            ...
            {/* {talkButton?.name && (
              <button
                className="px-6 h-9 rounded-lg border border-white text-white text-sm sm:text-base hover:bg-white hover:text-black transition"
                onClick={handleOpenForm}
              >
                {talkButton.name}
              </button>
