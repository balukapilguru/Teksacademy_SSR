...
console.log(course,"branchcourses")
  return (
    <div className="">
      <div
      ...
      >
        ...
        <div className="p-3 space-y-2">
          ...
          <div className="flex flex-wrap gap-2 text-center">
            <div className="bg-[#e6662a] p-2 pl-2 text-white rounded-md text-sm w-full    ">{course.batchInfo.title} : <span className="font-bold pl-2  pr-2 text-sm text-white">{course.batchInfo.date}</span></div>
          ...
          {/* Buttons */}
          <div
            className={`flex gap-4  mb-1 ${isSingle ? "justify-center" : "justify-between"
              }`}
          >
