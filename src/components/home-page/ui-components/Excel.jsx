...
const orangeItems = [
    { imgSrc: orange1, alt: "Career Guidance", title: "Free", description: "Career Guidance" },
    { imgSrc: orange2, alt: "Approved Curriculum", title: "IIT", description: "Approved Curriculum" },
    { imgSrc: orange3, alt: "Student Dashboard", title: "Dedicated", description: "Student Dashboard" },
    { imgSrc: orange4, alt: "& Online Trainings", title: "Classroom", description: "& Online Trainings" },
    { imgSrc: orange5, alt: "Recordings", title: "Class", description: "Recordings" },
];

const blueItems = [
    { imgSrc: blue1, alt: "Materials", title: "Course", description: "Materials" },
    { imgSrc: blue2, alt: "Based Assessments", title: "Module", description: "Based Assessments" },
    { imgSrc: blue3, alt: "On Projects", title: "Hands", description: "On Projects" },
    { imgSrc: blue4, alt: "Opportunity", title: "Internship", description: "Opportunity" },
    { imgSrc: blue5, alt: "Job Assistance", title: "100%", description: "Job Assistance" },
];
...
function FeaturePill({ imgSrc, alt, title, description, accent }) {
    return (
        ...
        >
            ...
            >
                <Image src={imgSrc} alt={alt} width={36} height={36} className="w-10 h-10 object-contain" />
            </div>
                    ...
                    <div className="grid grid-cols-2 gap-2.5">
                        ...
                        {orangeItems.map((item, i) => (
                            <React.Fragment key={`pair-${i}`}>
                                ...
                                {blueItems[i] && <FeaturePill {...blueItems[i]} accent="blue" />}
                            </React.Fragment>
                        ))}
                    </div>
                </div>
                    ...
                    {!showForm ? (
                        ...
                        >
                            <p className="text-white text-center text-sm font-medium leading-snug">
                                ...
                                <span className="text-teal-300 font-semibold">Get a free callback from our experts.</span>
                            </p>
                            ...
                            <button
                                ...
                                style={{
                                    background: "linear-gradient(90deg, #FE543D 0%, #ff7a5c 100%)",
                                    color: "#fff",
                            ...
                            <div className="flex items-center gap-4 mt-1">
                                {["IIT Approved", "100% Placement", "Live Classes"].map((badge) => (
                                    <div key={badge} className="flex items-center gap-1">
                                        <span className="text-teal-400 text-xs">✓</span>
                                        <span className="text-white text-[10px] font-medium">{badge}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between px-5 pt-5 pb-3">
                                <div>
                                    <p className="text-white font-bold text-base">Request a Callback</p>
                                    <p className="text-teal-300 text-xs">We'll reach out within 24 hrs</p>
                                </div>
                                <button
                                    ...
                                    <div className="flex items-center">
                                        <div className="flex flex-col gap-y-4 2xl:gap-y-8 3xl:gap-y-10">
                                            {orangeItems.map((item, index) => (
                                                <DesktopFeatureRow key={index} {...item} accent="orange" />
                                            ))}
                                        </div>
                                    </div>
                                    {/* Blue column */}
                                    <div className="flex items-center">
                                        <div className="flex flex-col gap-y-4 2xl:gap-y-8 3xl:gap-y-10">
                                            {blueItems.map((item, index) => (
                                                <DesktopFeatureRow key={index} {...item} accent="blue" />
                                            ))}
                                        </div>
                                    </div>
                                </div>
