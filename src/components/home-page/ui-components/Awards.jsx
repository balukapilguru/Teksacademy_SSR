  ...
  const galleryData = [
    {
      ...
      name: "Anna Smith",
      imgAward: Artboard1,
      imgLeaf: Most_trusted,
      alt: "Most Promising Data Science Training Institutes - 2023 by Silicon India.",
      about: 'Most Promising Data Science Training Institutes - 2023 by Silicon India.'
    },
    {
      id: 2,
      name: "Anna Smith",
      imgAward: Artboard2,
      imgLeaf: Most_trusted,
      alt: "Best Emerging Real-Time Training Academy of the Year ",
      about: 'Best Emerging Real-Time Training Academy of the Year - PRIDE OF INDIAN EDUCATION Awards by Brands Impact.'
    },
    {
      id: 3,
      name: "Anna Smith",
      imgAward: Artboard3,
      imgLeaf: Most_trusted,
      alt: "Best Online Training Institute of the Year",
      about: 'Best Online Training Institute of the Year - Hybiz TV Education Excellence Awards 2023'
    ...
    },
    {
      ...
      imgAward: Artboard4,
      imgLeaf: Most_trusted,
      alt: "Most Innovative Online Education Platform 2023",
      about: 'Most Innovative Online Education Platform 2023 - South India in Education and Training Awarded by Corporate Vision.'
    ...
    },
    {
      ...
      imgAward: Artboard5,
      imgLeaf: Most_trusted,
      alt: "Most Trusted Education Brand on Recognized of Outstanding Contribution Made by Teks Academy",
      about: 'Most Trusted Education Brand on Recognized of Outstanding Contribution Made by Teks Academy'
      ...
      <div className="main_container mx-auto py-2 lg:py-4 xl:py-6 2xl:py-8 3xl:py-10 justify-center items-center">
        ...
        <div className="grid gap-y-4 grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-3 px-2 md:px-4 lg:px-0 lg:gap-4 xl:gap-3 2xl:gap-10 pb-4">
          {galleryData.map((item, index) => (
            <div key={index} className="w-full flex gap-x-1 md:gap-x-2 xl:gap-x-1 2xl:gap-x-4 justify-center items-center">
              ...
              <div className="flex items-center justify-between w-1/2 relative ">
                ...
                width={300}
                height={300}
                src={leftleaf} alt="Left Leaf" className="w-16 xl:w-12 xl:h-28 2xl:w-16 h-28 sm:h-32 md:h-32 lg:h-32 2xl:h-32 3xl:w-20 3xl:h-36" />
                ...
                width={300}
                height={300}
                src={rightleaf} alt="Right Leaf" className="w-16 xl:w-12 xl:h-28 2xl:w-16 h-28 sm:h-32 md:h-32 lg:h-32 2xl:h-32 3xl:w-20 3xl:h-36" />
              </div>
            </div>
          ))}
          <div  className="w-full flex gap-x-1 md:gap-x-2 xl:gap-x-1 2xl:gap-x-4 justify-center items-center">
              <div className="border-2 w-1/2 flex flex-col justify-center rounded-md bg-[#EFF6F3]  ">
                <Image 
                width={300}
                height={300}
                className='rounded-lg h-auto p-2'
                  src={Artboard6}
                  alt='Education Excellence Awards 2024 by Kapil Groups'
                />
              </div>
              <div className="flex items-center justify-between w-1/2 relative ">
                <Image
