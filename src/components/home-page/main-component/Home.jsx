...
export default async function Home() {
  ...
  const sectionsConfig = [
    ...
    { component: <Whyteksversity whyTeksversity={homeData?.whyTeksversity} />, bg: "#fbf5f6", border: "#fbf5f6" },
    { component: <Blueribbon blueribbon={homeData?.makingAbroadEducationEasier} />, bg: "#fff", border: "#fff" },
    { component: <HiringCompanies hiringData={homeData?.hiringPartners} />, bg: "#fbf5f6", border: "#fbf5f6" },
    ...
    { component: <Gallery gallery={homeData?.gallery} />, bg: "#fff", border: "#fff" },
    { component: <Featuredin featuredIn={homeData?.featuredIn} />, bg: "#fbf5f6", border: "#fbf5f6" },
    ...
    <>
      <div>
        ...
        {sectionsConfig.map((sec, idx) => (
          <section key={idx} style={{ backgroundColor: sec.bg, borderColor: sec.border, }} className='md:py-4 xl:py-6  main_container rounded-lg' >
            {sec.component}
          </section>
        ))}
      </div>
