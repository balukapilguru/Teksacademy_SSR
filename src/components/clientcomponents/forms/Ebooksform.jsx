        ...
        <div className="flex justify-between items-center mb-4">
          <div>
            ...
            <p className="text-sm text-gray-600">
              ...
              <span className="font-medium text-[#2a619d]">{course}</span>
            </p>
          </div>

          <button
            className="p-2 bg-[#2a619d] text-white rounded-lg hover:bg-[#a31a2d] transition"
            onClick={closePopup}
            type="button"
        ...
        <form className="space-y-1" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-3 border border-gray-300 rounded-lg text-sm focus:ring-1 focus:ring-[#2a619d] focus:border-transparent outline-none"
              required
              disabled={isSubmitting}
            />
          </div>
