...
const Specializations = ({ data }) => {
  ...
  function ServiceCardComponent({ service }) {
    ...
    return (
      <div className="bg-white rounded-2xl p-2 h-32 xl:h-24 cursor-pointer border border-gray-200 hover:border-[#2a619d] transition-all duration-300 hover:shadow-md shadow-sm flex flex-col justify-between">
