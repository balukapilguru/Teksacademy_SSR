                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl shadow-md border border-gray-100 p-0 overflow-hidden">
                  <div className="grid md:grid-cols-2 relative">
                    {/* Left Side: View Discounts */}
                     <div className="bg-gradient-to-tr from-[#002b80] via-[#002b80] to-[#2a619d] text-white p-8 flex flex-col justify-center relative overflow-hidden">
                   ...
                   <div className="p-8 flex flex-col justify-center text-center bg-white">
                      ...
                      <button
                        ...
                        className="w-full bg-gradient-to-r from-[#2a619d] to-[#002b80] cursor-pointer text-white px-6 py-3 rounded-xl font-medium hover:opacity-90 transition shadow"
                      >
                        View Discounts
                      </button>
                    </div>
            ...
            <div className="w-full md:w-1/2 p-6 flex flex-col justify-center border-r border-gray-200">
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3 bg-[#2a619d] text-white rounded-lg hover:bg-[#a01a30]"
                >
              ...
              <div className="space-y-2">
                ...
                <div className="bg-yellow-50 border border-yellow-300 p-3 rounded-lg">
                  <div className="text-base text-yellow-700 font-medium">
                    ...
                    <span className="text-2xl font-bold text-[#2a619d]">
                      Save up to ₹35,000!
                    </span>
                  </div>
                </div>
              </div>
              <button className="mt-6 w-full py-2 cursor-pointer bg-[#2a619d] text-white rounded-lg font-semibold hover:bg-[#a01a30]">
