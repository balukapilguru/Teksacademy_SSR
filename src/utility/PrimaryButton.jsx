...
export default function PrimaryButton({
  ...
  const variants = {
    filled:
      "cursor-pointer text-sm bg-[#c41e3a] text-white hover:bg-[#a31a32] h-10 px-4 flex items-center justify-center",
    outline:
      "cursor-pointer text-sm border border-[#c41e3a] text-[#c41e3a] hover:bg-[#c41e3a] hover:text-white h-10 px-4 flex items-center justify-center",
    light:
