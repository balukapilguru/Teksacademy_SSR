...
console.log(response.data,"successtories")
  ...
  const contactBar = data?.contactBar || null;
  const mostSearchedTerms = data?.mostSearchedTerms || null;
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                {heroSection?.description && (
                  <p className="text-gray-500 mb-6">{heroSection.description}</p>
                )}
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10 px-4">
            {alumniCards.map((item, index) => (
              <div key={index} className="text-center">
                ...
                <p className="text-orange-500 text-xs mt-1">{item.role}</p>
