    ...
    <div className="bg-slate-950 text-white flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl w-full">
        <div className="text-center mb-12 mt-4">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-500/10 border border-[#2a619d] rounded-full mb-4">
            <FaExclamationCircle className="w-4 h-4 text-[#2a619d]" />
            <span className="text-sm text-[#2a619d] font-medium">
